  ...
  <div className="absolute w-0 h-0 icon-defs">
    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        >
          <path
            d="M20.8333 14.5833C21.9839 14.5833 22.9167 13.6506 22.9167 12.5C22.9167 11.3494 21.9839 10.4166 20.8333 10.4166C19.6827 10.4166 18.75 11.3494 18.75 12.5C18.75 13.6506 19.6827 14.5833 20.8333 14.5833Z"
            fill="#6B3F91"
          />
          <path
            d="M19.8654 5.13442C18.4087 3.6776 16.5526 2.68549 14.5319 2.28355C12.5113 1.8816 10.4168 2.08787 8.51344 2.87628C6.61003 3.66469 4.98315 4.99982 3.83855 6.71283C2.69394 8.42585 2.08301 10.4398 2.08301 12.5C2.08301 14.5603 2.69394 16.5742 3.83855 18.2873C4.98315 20.0003 6.61003 21.3354 8.51344 22.1238C10.4168 22.9122 12.5113 23.1185 14.5319 22.7165C16.5526 22.3146 18.4087 21.3225 19.8654 19.8657L12.4998 12.5L19.8654 5.13442ZM10.4165 9.37504C10.0044 9.37504 9.60165 9.25286 9.25905 9.02394C8.91644 8.79502 8.64942 8.46965 8.49173 8.08897C8.33405 7.70829 8.29279 7.2894 8.37318 6.88527C8.45357 6.48115 8.65198 6.10993 8.94334 5.81857C9.2347 5.52721 9.60592 5.32879 10.01 5.24841C10.4142 5.16802 10.8331 5.20928 11.2137 5.36696C11.5944 5.52465 11.9198 5.79167 12.1487 6.13427C12.3776 6.47688 12.4998 6.87967 12.4998 7.29171C12.4998 7.84425 12.2803 8.37415 11.8896 8.76485C11.4989 9.15555 10.969 9.37504 10.4165 9.37504Z"
            fill="#6B3F91"
          />
        </symbol>
      </defs>
