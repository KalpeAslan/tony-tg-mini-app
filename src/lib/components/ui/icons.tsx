  ...
  <div className="absolute w-0 h-0 icon-defs">
    <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        ...
        <symbol id="mission-icon" viewBox="0 0 46 45" fill="none">
          <path
            d="M45.3384 7.14322C45.1832 6.52262 44.5626 6.21231 43.942 6.21231H39.2875V1.55779C39.2875 0.937191 38.9772 0.316588 38.3566 0.161437C37.736 -0.148864 37.1154 0.00628636 36.65 0.471738L30.4439 6.67777C30.1336 6.98807 29.9785 7.29837 29.9785 7.76382V13.3492L21.1349 22.1928C20.5143 22.8134 20.5143 23.7443 21.1349 24.3649C21.4452 24.6752 21.9106 24.8304 22.2209 24.8304C22.5312 24.8304 22.9967 24.6752 23.307 24.3649L32.1506 15.5214H37.736C38.2015 15.5214 38.5118 15.3662 38.8221 15.0559L45.0281 8.84988C45.4936 8.38442 45.6487 7.76382 45.3384 7.14322Z"
            fill="white"
          />
          <path
            d="M25.4791 26.5371C24.7033 27.468 23.4621 27.9334 22.2209 27.9334C20.9797 27.9334 19.7385 27.468 18.9628 26.5371C17.1009 24.6753 17.1009 21.7274 18.9628 20.0207L23.307 15.6765C22.9967 15.5214 22.5312 15.5214 22.2209 15.5214C17.8767 15.5214 14.4634 18.9347 14.4634 23.2789C14.4634 27.6231 17.8767 31.0364 22.2209 31.0364C26.5651 31.0364 29.9785 27.6231 29.9785 23.2789C29.9785 22.9686 29.9785 22.5031 29.8233 22.1928L25.4791 26.5371Z"
            fill="white"
          />
          <path
            d="M40.9943 17.228C40.2186 18.1589 38.9774 18.6244 37.7362 18.6244H33.392L32.3059 19.7104C32.7714 20.7965 32.9265 22.0377 32.9265 23.2789C32.9265 29.3298 28.1168 34.1394 22.066 34.1394C16.0151 34.1394 11.2054 29.3298 11.2054 23.2789C11.2054 17.228 16.0151 12.4183 22.066 12.4183C23.3072 12.4183 24.5484 12.7287 25.6344 13.039L26.8756 12.108V7.76383C26.8756 6.52262 27.3411 5.28142 28.272 4.50566L29.8235 2.95416C27.3411 2.02325 24.8587 1.5578 22.2211 1.5578C10.2745 1.5578 0.5 11.3323 0.5 23.2789C0.5 35.2255 10.2745 45 22.2211 45C34.1677 45 43.9422 35.2255 43.9422 23.2789C43.9422 20.6413 43.4768 18.1589 42.5458 15.6765L40.9943 17.228Z"
            fill="white"
          />
        </symbol>

        <symbol id="play" viewBox="0 0 12 14" fill="none">
        ...
        <symbol id="ticket" viewBox="0 0 34 34" fill="none">
          <path
            d="M26.9066 21.2573L14.1957 33.9683L9.93698 29.7096C10.6861 28.9604 11.1055 27.9428 11.1027 26.8807C11.1 25.8185 10.6755 24.7988 9.9225 24.0458C9.16951 23.2928 8.14977 22.8682 7.0876 22.8655C6.02544 22.8628 5.00785 23.2821 4.25871 24.0313L0 19.7726L12.7109 7.06165L16.2599 10.6106L17.6722 9.19824L14.1233 5.64932L19.7726 1.58381e-05L24.0313 4.25872C23.2821 5.00787 22.8628 6.02545 22.8655 7.08762C22.8682 8.14978 23.2928 9.16953 24.0458 9.92251C24.7987 10.6755 25.8185 11.1 26.8807 11.1028C27.9428 11.1055 28.9604 10.6861 29.7095 9.937L33.9683 14.1957L28.319 19.845L24.77 16.2961L23.3577 17.7084L26.9066 21.2573ZM17.6794 12.0301L21.9381 16.2888L23.3505 14.8765L19.0918 10.6178L17.6794 12.0301Z"
            fill="currentColor"
          />
        </symbol>

        <symbol id="chevron-left" viewBox="0 0 9 16" fill="none">
          <path
            d="M0.292893 7.29289C-0.0976309 7.68342 -0.097631 8.31658 0.292893 8.70711L6.65685 15.0711C7.04738 15.4616 7.68054 15.4616 8.07107 15.0711C8.46159 14.6805 8.46159 14.0474 8.07107 13.6569L2.41421 8L8.07107 2.34315C8.46159 1.95262 8.46159 1.31946 8.07107 0.928933C7.68054 0.538408 7.04738 0.538408 6.65685 0.928932L0.292893 7.29289ZM4 7L1 7L1 9L4 9L4 7Z"
            fill="white"
          />
        </symbol>

        <symbol id="arcade" viewBox="0 0 44 39" fill="none">
          <g style={{ mixBlendMode: 'luminosity' }} filter="url(#filter0_d_0_1)">
            <path
              d="M39.9821 13.2865C39.9391 7.93945 38.5082 2.72146 37.7444 2.01138C36.9483 1.3551 29.6218 0.0532889 22.0049 0.0102539C14.3773 0.0425301 7.05082 1.34434 6.25471 2.00062C5.48011 2.72146 4.06 7.93945 4.01697 13.2865C3.84484 18.6336 5.10356 24.2067 5.80286 25.6591C6.45912 26.8856 14.1298 28.5317 22.0049 28.6285C29.88 28.5317 37.54 26.8856 38.207 25.6591C38.9063 24.2067 40.165 18.6336 39.9929 13.2865H39.9821Z"
              fill="url(#paint0_radial_0_1)"
            />
            <path
              d="M4.01795 15.3748C4.16856 19.9903 5.19061 24.3368 5.80383 25.5956C6.46009 26.8221 14.1308 28.4682 22.0059 28.565C29.881 28.4682 37.541 26.8221 38.208 25.5956C38.8104 24.3368 39.8432 19.9903 39.9939 15.3748C39.9939 15.4178 39.9939 15.4608 39.9939 15.5039C40.166 20.851 38.9073 26.424 38.208 27.8764C37.5517 29.1029 29.881 30.749 22.0059 30.8458C14.1308 30.749 6.47085 29.1029 5.80383 27.8764C5.09378 26.424 3.83505 20.851 4.01795 15.5039C4.01795 15.4608 4.01795 15.4178 4.01795 15.3748Z"
            ...
            />
            <path
              d="M29.8333 16.5833C30.9839 16.5833 31.9167 15.6506 31.9167 14.5C31.9167 13.3494 30.9839 12.4166 29.8333 12.4166C28.6827 12.4166 27.75 13.3494 27.75 14.5C27.75 15.6506 28.6827 16.5833 29.8333 16.5833Z"
              fill="#565656"
            />
            <path
              d="M28.8654 7.13442C27.4087 5.6776 25.5526 4.68549 23.5319 4.28355C21.5113 3.8816 19.4168 4.08787 17.5134 4.87628C15.61 5.66469 13.9832 6.99982 12.8385 8.71283C11.6939 10.4259 11.083 12.4398 11.083 14.5C11.083 16.5603 11.6939 18.5742 12.8385 20.2873C13.9832 22.0003 15.61 23.3354 17.5134 24.1238C19.4168 24.9122 21.5113 25.1185 23.5319 24.7165C25.5526 24.3146 27.4087 23.3225 28.8654 21.8657L21.4998 14.5L28.8654 7.13442ZM19.4165 11.375C19.0044 11.375 18.6016 11.2529 18.259 11.0239C17.9164 10.795 17.6494 10.4696 17.4917 10.089C17.3341 9.70829 17.2928 9.2894 17.3732 8.88527C17.4536 8.48115 17.652 8.10993 17.9433 7.81857C18.2347 7.52721 18.6059 7.32879 19.01 7.24841C19.4142 7.16802 19.8331 7.20928 20.2137 7.36696C20.5944 7.52465 20.9198 7.79167 21.1487 8.13427C21.3776 8.47688 21.4998 8.87967 21.4998 9.29171C21.4998 9.84425 21.2803 10.3741 20.8896 10.7649C20.4989 11.1556 19.969 11.375 19.4165 11.375Z"
              fill="#565656"
            />
          </g>
          <defs>
            ...
            <radialGradient
              ...
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(22.1464 34.0204) scale(34.2079 30.6824)"
            >
        ...
        <symbol id="arcade-selected" viewBox="0 0 66 58" fill="none">
          <g filter="url(#filter0_d_0_1)">
            <path
              d="M61.9606 21.9521C61.8913 13.458 59.5866 5.16894 58.3563 4.04094C57.0741 2.99841 45.2736 0.930424 33.0053 0.862061C20.7196 0.913333 8.91913 2.98132 7.63685 4.02385C6.38922 5.16894 4.10191 13.458 4.0326 21.9521C3.75535 30.4462 5.78274 39.2992 6.90907 41.6065C7.96609 43.5548 20.3211 46.1697 33.0053 46.3235C45.6895 46.1697 58.0271 43.5548 59.1015 41.6065C60.2278 39.2992 62.2552 30.4462 61.9779 21.9521H61.9606Z"
              fill="url(#paint0_radial_0_1)"
            />
            <path
              d="M4.03379 25.2693C4.27638 32.6012 5.92256 39.5059 6.91026 41.5055C7.96728 43.4539 20.3222 46.0688 33.0065 46.2226C45.6907 46.0688 58.0283 43.4539 59.1026 41.5055C60.073 39.5059 61.7365 32.6012 61.9791 25.2693C61.9791 25.3377 61.9791 25.406 61.9791 25.4744C62.2564 33.9685 60.229 42.8215 59.1026 45.1288C58.0456 47.0771 45.6907 49.692 33.0065 49.8458C20.3222 49.692 7.98461 47.0771 6.91026 45.1288C5.7666 42.8215 3.73921 33.9685 4.03379 25.4744C4.03379 25.406 4.03379 25.3377 4.03379 25.2693Z"
              fill="#E07A19"
            />
          </g>
          <path
            d="M45.3382 27.1791C47.1792 27.1791 48.6715 25.6867 48.6715 23.8458C48.6715 22.0048 47.1792 20.5125 45.3382 20.5125C43.4973 20.5125 42.0049 22.0048 42.0049 23.8458C42.0049 25.6867 43.4973 27.1791 45.3382 27.1791Z"
            fill="#B85700"
          />
          <path
            d="M43.7898 12.0606C41.4589 9.72972 38.4892 8.14234 35.2562 7.49923C32.0232 6.85612 28.672 7.18616 25.6266 8.44761C22.5811 9.70906 19.9781 11.8453 18.1468 14.5861C16.3154 17.3269 15.3379 20.5493 15.3379 23.8456C15.3379 27.142 16.3154 30.3643 18.1468 33.1052C19.9781 35.846 22.5811 37.9822 25.6266 39.2436C28.672 40.5051 32.0232 40.8351 35.2562 40.192C38.4892 39.5489 41.4589 37.9615 43.7898 35.6306L32.0048 23.8456L43.7898 12.0606ZM28.6715 18.8456C28.0122 18.8456 27.3677 18.6501 26.8195 18.2839C26.2714 17.9176 25.8441 17.397 25.5919 16.7879C25.3396 16.1788 25.2735 15.5086 25.4022 14.862C25.5308 14.2154 25.8483 13.6214 26.3144 13.1553C26.7806 12.6891 27.3745 12.3716 28.0211 12.243C28.6678 12.1144 29.338 12.1804 29.9471 12.4327C30.5561 12.685 31.0767 13.1122 31.443 13.6604C31.8093 14.2086 32.0048 14.853 32.0048 15.5123C32.0048 16.3963 31.6536 17.2442 31.0285 17.8693C30.4034 18.4944 29.5555 18.8456 28.6715 18.8456Z"
            fill="#B85700"
          />
          <defs>
            <filter
            ...
            <radialGradient
              ...
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(33.2331 54.8887) scale(55.0976 48.7405)"
            >
              <stop stop-color="#FFB42A" />
              <stop offset="0.31" stop-color="#FFBF34" />
              <stop offset="0.85" stop-color="#FFDE4E" />
        ...
        <symbol viewBox="0 0 16 16" fill="none" id="dots" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <symbol id="web" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
